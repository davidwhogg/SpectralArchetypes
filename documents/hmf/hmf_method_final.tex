...
Roweis,~S. \& Ghahramani,~Z., 1999, Neural Computation, 11, 305

\bibitem[Sanguinetti et al.(2005)]{bio}
Sanguinetti,~G., Milo,~M., Rattray,~M., Lawrence,~N.~D. 2005, Bioinformatics, 21, 19, 3748
...
Wilson,~A.~G., Ghahramani,~Z. 2011, http://uai.sis.pitt.edu/papers/11/p736-wilson.pdf

\bibitem[Wilson \etal(2011)]{wilsonb}
Wilson,~A.~G., Knowles,~D.~A., Ghahramani,~Z. 2011, arXiv:1110.4411
...
\begin{figure}
\subfigure{
\includegraphics[angle=-90,width=0.89\columnwidth]{paper_plots/fig2}
}
\subfigure{
\includegraphics[angle=-90,width=0.89\columnwidth]{paper_plots/fig3}
}
\end{figure}
\begin{figure}
\subfigure{
\includegraphics[angle=-90,width=0.89\columnwidth]{paper_plots/fig4}
}
