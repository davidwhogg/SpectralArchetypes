...
super-massive black-hole binaries. We apply a hypothesis test to
...
have scaled the spectra; HOGG SAY: fix this description).  The initialization we use is the mean spectrum
