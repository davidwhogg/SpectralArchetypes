...
\slugcomment{\texttt{draft 2011-06-20 / not ready for distribution}}
...
determination (\citealp{glazebrook}; 
\citealp{budavari}), emission-line measurements and properties of objects (\citealp{allen}; 
\citealp{borosona}; \citealp{wild}; \citealp{borosonc}), 
decomposition into different stellar populations (\citealp{chen}; 
\citealp{ferreras}; \citealp{nolan}) and outlier indedification and classification of sources (\citealp{suzuki}; 
\citealp{francis}; \citealp{yip}; \citealp{yipb}; \citealp{connolly}; \citealp{connolly}; \citealp{borosona}) can all in
...
GALAXY\_RED as well) and made sure that they meet the criteria of \citep{eisenstein}.
