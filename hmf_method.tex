...
% - we ought to say that there are other optimization methods possible that take the full gradient (ie, not ones that iterate least-squares).

\documentclass[12pt,preprint,pdftex]{aastex}
\usepackage{amssymb,amsmath,mathrsfs}

\slugcomment{\texttt{draft 2011-10-14 / not ready for distribution}}
...
129 of the 131 lens candidates in our sample and all 4 of the known
...
spectrum is a bound pair of super-massive black holes (\citealt{komossa}; 
\citealt{shields}: \citealt{boroson}; \citealt{decarli}).  In both
...
that is, a wavelength area for which at least 10 sources have valid data
...
(for example, negative emission lines). We should keep in mind though that
...
could also be another type of source (for example, a QSO). Another application
