...
included in the spectral range of the fit. In this way we detected peaks for 120 SLACS 
spectra at the same redshifts as those found in the SLACS survey 
(for an example, see \figurename~\ref{fig:6}).

For the remaining 11 cases we applied the same procedure but this
