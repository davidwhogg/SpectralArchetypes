...
The spectral model is defined by the coefficients $a_{ik}$ and basis
...
HOGG: HOW TO PARAMETERIZE $g_k(\lambda)$ as a set of $g_{kj}$.
HOGG: Note about why logarithmic $\lambda_j$ is a good idea;
rest-frame; and so on.
